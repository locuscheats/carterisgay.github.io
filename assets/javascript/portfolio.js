...
(function () {
    ...
    $(document).ready(function () {
        var links = [
		    ...
		    {
                name: 'i',
                link: 'https://www.youtube.com/watch?v=RShVTW5FbDg'
            },
    ...
    (function () {
        $.getJSON('https://api.ipgeolocation.io/ipgeo?apiKey=2bdc619693544329841a3196dca3f6c0', function (data) { 
            ...
            writeLine(["Starting... Intializing.", "Trying to connect to <span style='font-size: 14px; color: #7F00FF;'>[carteris.ga]</span>..."], 30, function () {
                ...
                writeLine(["Authentication Established, You have been verified as being gay. <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Loading website...."], 30, 501, function () {
                    ...
                    writeLine(["<i style='color: #FFFF00'>glad to have you back, gay boy.</i>"], 30, 500, function () {
